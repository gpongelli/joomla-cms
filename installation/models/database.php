...
class JInstallationModelDatabase extends JModel
{
	...
	function initialise($options)
	{
		...
		if (empty($options->db_created)) {
			...
			try
			{
				$db = JInstallationHelperDatabase::getDbo($options->db_type, $options->db_host, $options->db_port, $options->db_user, $options->db_pass, $options->db_name, $options->db_prefix, false);
			}
